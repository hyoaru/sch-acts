...
public class ExpressionConversionUtilities {
    private String brackets;
    private String openingBrackets;
    private String closingBrackets;

    ExpressionConversionUtilities(String brackets, String openingBrackets, String closingBrackets){
        this.brackets = brackets;
        this.openingBrackets = openingBrackets;
        this.closingBrackets = closingBrackets;
    }

    public ExpressionConversionUtilities() {
    }
